...
INSERT INTO `article_pop` (`sid`, `teacher_sid`, `artical_category`, `artical_title`, `artical_image`, `artical_content`, `created_date`, `likes`, `hyperlink`, `updated`) VALUES
(93, '1', '異國節慶', '燃燒自我的限時烏托邦　美國火燒人慶典', '01.png', '集合藝術、音樂與一切其他無法以言語形容奇事，每年出現在美國內華達州黑石沙漠一次，為期八天的「火燒人慶典」，在這裡參與者可以換上最怪的衣服，創造各式造型特異怪誕卻極有自我風格的裝置藝術，只要不做出傷天害理、妨害他人的事，你可以盡情在此活出自己，體驗自由的真諦。', '2021-08-22', 300, 'https://www.youtube.com/embed/UiKcdWUpvrY', '2021-08-22 05:50:13'),
(95, '1', '專欄文章', '眼動科學，為失語者開啟一扇溝通的窗', '09.jpg', '俗話說，眼睛是靈魂之窗，台灣一家科技新創「森思眼動」，用眼動科技為失語者開啟一扇溝通的窗，讓情感得以表達、靈魂得以釋放。\n\n因漸凍人朋友需求，無心插柳跨足輔具領域\n森思眼動的創業故事，可說是無心插柳柳成蔭。公司創立之初，森思眼動計劃投入電商市場，運用眼動科技分析大眾如何閱讀電商網站，並蒐集數據以幫助廣告商最有效率地規劃廣告版位。', '2021-08-18', 585, 'https://www.youtube.com/embed/FFwrS7UtACw', '2021-08-22 05:56:23'),
(96, '2', '熱門影集', '亞森羅蘋', '08.jpeg', '亞森羅蘋》依然是如此精彩，完全不輸給第一季，已經很久沒看到影集中主角光環大開之下，還這麼有說服力的，不僅將劇情的邏輯描述得頭頭是道，故事的發展不管怎麼神展開，都有辦法被很完美的給接回來，許多漂亮的轉折安排更是讓人拍案叫絕，再加上整齣劇的節奏掌握十分上乘，完全抓住我們的緊張情緒，讓人一集接一集完全停不下來，現在開始敲碗期待《亞森羅蘋》第三季的到來！\n女兒節當天雖然不是日本國定假日，但家中的成員大都盡量聚在一起祝福女孩子健康平安的長大成人。父母會為女兒設置階梯狀的陳列台，由上至下，擺放穿著日式和服的娃娃，這種娃娃在日本稱為雛人形。為慶賀這個節日每個有女孩子的日本家庭都會擺放「女兒節人偶」，以祈求女兒幸福健康的成長。女兒節的做工講究、服飾華麗的人偶娃娃也成為日本人最喜愛的人偶之一，特別是富有家庭，會為女兒準備由名匠製作的漂亮人偶娃娃。', '2021-08-23', 474, 'https://www.youtube.com/embed/uFS9RZXu3YA', '2021-08-22 05:58:14'),
...
(98, '3', '專欄文章', '讀國文，從來就不是為了學修辭', '06.jpg', '「國語文」是一個領域，是「國語」和「國文」的混合。我們現在所通行的這套語文系統，是1945年中華民國政府帶來的。在此之前的日本時代，台灣流行的是日語、台語、客語和原住民各族的語言；有部分的漢人也會寫中文字，他們稱之為「漢文」，不管是文言漢文還是白話漢文，在發音的時候都是用台語來唸的。1945年，國民政府接收台灣，成立了「國語推行委員會」，才開始一系列當代「國語」的建構工程。\n \n\n原本日本是沒有文字的，一直到和中國有了交流之後才引進中國的漢字，後來發展成「萬葉假名」，一直到後來簡化為平假名和片假名。萬葉假名是來自於「萬葉集」，且一個漢字僅有一個音，譬如「久佐麻久良」讀作「ku-sa-ma-ku-ra」,意思是「草枕」，看起來很複雜又麻煩，無論是閱讀還是書寫都造成了很大的障礙，因此日本人開始嘗試將它簡化。抽取漢字部首，簡化萬頁假名的筆畫，這就是「片假名」。現今片假名多用於外來語，並不是日本人常用的字母。\n\n \n\n古代日本女性無法接受正規教育，就像中國古代的「女子無才便是德」。女孩子是不能學習漢字及片假名的。因此她們創造出了另一種字母系統，也就是現今日文的主流「平假名」 (又稱為「女手」、「女文字」)。相較於片假名剛硬、單調的筆畫，平假名以圓滑、柔潤取勝，字型較優雅、書寫容易，迅速在日本平安女性之間流傳，進而創造出傳奇的「平安文學」。後來為了讓女性也能看的懂私信以及政府公文，而改用平假名書寫，漸漸的平假名成為日本語的主流，而片假名則退居二線成為外來語的代名詞。對於發明文字，日本女性有著非常大的功勞，例如紫式部的《源氏物語》(日本歷史上第一部長篇小說)，到現今一直都廣為人知。', '2021-08-22', 50, 'https://www.youtube.com/embed/QWGUclg-Q2M', '2021-08-22 06:02:29'),
...
(101, '4', '熱門影集', '柏捷頓家族名門韻事', '03.jpg', '《柏捷頓家族：名門韻事》為2020年Netflix原創影集，改編自美國暢銷羅曼史小說家茱莉亞昆恩的《柏捷頓家族》系列作品，講述19世紀初英國倫敦上流社會故事的《柏捷頓家族：名門韻事》今日公佈了首波劇照以及上線日期，這部講述英國攝政時期倫敦名門望族愛情糾葛的影集甚至被認為是為《王冠》完結所做準備，準備接替上的強檔英倫古裝影集！', '2021-08-18', 1515, 'https://www.youtube.com/embed/WygHZyE3ufQ', '2021-08-22 15:24:44'),
...
(103, '5', '熱門影集', '黑道律師文森佐', '01.png', '此劇講述因組織內部糾紛而從義大利逃到韓國的黑手黨顧問文森佐·卡薩諾（宋仲基飾），在遇上律師洪車瑛（全汝彬飾）後，兩人以黑道的方式實現正義的故事。\n日本參議院在決議時指出，「為終結傳染病，必須共享世界各地在公衛上取得成果的地區有用的知識與經驗」，「台灣作為強化檢疫的先驅，不能參加WHA是全球在國際防疫上的損失，這是各國的共識」，希望相關國家明年起能夠認可台灣參與。', '2021-08-16', 100000000, 'https://www.youtube.com/embed/NIVPCHE34sI', '2021-08-22 15:31:09');
...
--
ALTER TABLE `schedule`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4852;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `viewcount`
--
ALTER TABLE `viewcount`
