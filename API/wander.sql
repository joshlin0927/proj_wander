...
(17, 0, 0, 0, NULL, NULL, 'admin', 'admin', 'admin', 'admin@admin', '$2a$10$Uj1D97IAB63CQMT7UF6kQuPlRlI0uSgvhYmta3lF3U5.i8goi/Wsy', NULL, NULL, NULL, NULL, NULL, '2021-11-17'),
...
--
ALTER TABLE `member`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1024;
